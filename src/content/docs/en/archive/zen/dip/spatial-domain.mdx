...
import assetGammaCorrection from '../../../../assets/dip/gamma-correction.png';
import assetContrastStretching from '../../../../assets/dip/contrast-stretching.png';
import assetIntensityLevelSlicing from '../../../../assets/dip/intensity-level-slicing.png';
...
<img src={assetGammaCorrection.src} />
...
<img src={assetContrastStretching.src} />
<div align="right"><em>Image Credits: Book by Gonzalez, Woods</em></div>

#### Intensity-Level Slicing

<img src={assetIntensityLevelSlicing.src} />
<div align="right"><em>Image Credits: Book by Gonzalez, Woods</em></div>
