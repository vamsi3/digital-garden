...
import imageDualGraph from '@assets/cp/dual-graph.png';
import imageDualGraphSpanningTree from '@assets/cp/dual-graph-spanning-tree.png';
...
| :---: | :----: |
| <Image src={imageDualGraph} alt="" /> | <Image src={imageDualGraphSpanningTree} alt="" /> |
